...
class opts(object):
    def __init__(self):
        ...
        self.parser.add_argument('--hide_data_time',
                                 action='store_true',
        ...
        self.parser.add_argument('--vis_thresh',
                                 type=float,
                                 default=0.35,
                                 help='visualization threshold.')
        self.parser.add_argument('--debugger_theme',
                                 default='white',
                                 choices=['white', 'black'])
        ...
        # test
        self.parser.add_argument('--flip_test',
                                 action='store_true',
                                 help='flip data augmentation.')
        self.parser.add_argument('--test_scales',
                                 type=str,
                                 default='1',
                                 help='multi scale test augmentation.')
        self.parser.add_argument('--nms',
                                 action='store_true',
        ...
        self.parser.add_argument('--eval_oracle_hm',
                                 action='store_true',
                                 help='use ground center heatmap.')
        self.parser.add_argument('--eval_oracle_wh',
                                 action='store_true',
        ...
        self.parser.add_argument('--eval_oracle_kps',
                                 action='store_true',
        ...
        self.parser.add_argument('--eval_oracle_dep',
                                 action='store_true',
