...
from .config.twodet_config import cfg_two_stage, Struct_Component_Cfg
...
def train_epoch(model,
    ...
    if (epoch + 1) % 10 == 0 and management:
        ...
        ckp.save(name='{}_{}_epoch_{}_loss_{:.4f}'.format(
            'resnet18', 'voc07_to_coco', epoch,
            losses.cpu().item()))
        print(
            'saved!!!!!',
            '{}_epoch_{}_loss_{:.4f}'.format('voc07_to_coco', epoch,
                                             losses.cpu().item()))
